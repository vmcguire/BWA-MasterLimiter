# BWA-MasterLimiter — read before doing anything

> ✅ **This is the CANONICAL home for BWA-MasterLimiter.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-MasterLimiter/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-MasterLimiter; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-MasterLimiter**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-MasterLimiter`) and attach the notarized `BWA-MasterLimiter.vst3`.
